...
app.post('/api/products/:id', db.updateProduct);{title,price,tags}
...
app.post('/api/purchase_item/:id', db.updatePurchase_item); {purchase_id, product_id,price,quantity,status}
...
app.post('/api/purchase/:id', db.updatePurchase); {created_at,name,address,state,zipcode,user_id}
...
app.post('/api/User/:id', db.updateUser); {email,password,details,created_at}
